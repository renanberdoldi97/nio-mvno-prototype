...
export default function EscolherTipoPage() {
  ...
  // Também garante que isOtherDevice não vaza de uma jornada anterior —
  // esta é a entrada padrão do fluxo de aparelho único.
  useEffect(() => {
        ...
        <>
          ...
          <Button
            ...
            onClick={() => {
              ...
              router.push('/pedir-chip/outro-aparelho');
            }}
          >
